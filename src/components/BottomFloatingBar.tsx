    ...
    >
      <div className="max-w-md mx-auto px-4 w-full flex items-center justify-center gap-2.5 sm:gap-3 pointer-events-auto">
        ...
        <a
          ...
          aria-label={`카카오톡 상담 문의 (${siteConfig.kakaoId || '상담'})`}
        ...
        >
          ...
          <div className="text-left leading-tight truncate">
            <span className="block text-[10px] text-slate-950 font-bold">카카오톡 상담</span>
            <span className="font-black text-xs sm:text-sm text-slate-950 truncate block">
              {siteConfig.kakaoId}
            </span>
          </div>
        </a>
        ...
        >
          ...
          <div className="text-left leading-tight truncate">
            <span className="block text-[10px] text-white font-bold">텔레그램 상담</span>
